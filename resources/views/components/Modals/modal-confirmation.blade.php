...
<div x-data="{
    closeModal() {
        if (typeof closeToggleModal === 'function') {
            closeToggleModal();
        } else {
    ...
    <x-modal :name="$name" :show="$show" maxWidth="md">
        <div class="p-6 space-y-4">
            ...
            <div class="flex justify-center">
                <div class="w-14 h-14 flex-shrink-0 flex items-center justify-center rounded-full {{ $variant === 'user' ? 'bg-yellow-100' : 'bg-red-100' }}">
                    @if($variant === 'user')
