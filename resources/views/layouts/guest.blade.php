    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative z-10 px-4">
        <div class="w-full {{ $maxWidth }}">
            <div class="mb-8 flex justify-center">
                <a href="/"
                    class="group flex flex-col items-center gap-4 transition-transform duration-300 hover:scale-105">
                    <img src="{{ asset('Icon-SAPA.jpeg') }}" alt="SAPA E-Antrian"
                        class="w-24 h-24 object-contain rounded-xl drop-shadow-md" />
