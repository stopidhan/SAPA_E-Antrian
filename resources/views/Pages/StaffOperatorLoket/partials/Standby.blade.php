...
|--------------------------------------------------------------------------
--}}
<div x-show="state === 'standby'" x-transition:enter="transition ease-out duration-150"
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <span
                class="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-100 text-gray-500 text-xs font-semibold rounded-full">
        ...
        <div class="px-6 py-16 text-center">
            <div class="w-20 h-20 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <svg class="w-10 h-10 text-gray-300" fill="none" stroke="currentColor" stroke-width="1.2"
                    viewBox="0 0 24 24">
        ...
        {{-- Tombol Panggil Berikutnya / Buka Sesi --}}
        <div class="px-6 pb-6">
            <template x-if="!counterId">
                <button @click="showLoketModal = true"
                    class="w-full flex items-center justify-center gap-3 py-4 text-white text-base font-bold rounded-xl shadow-sm transition bg-amber-500 hover:bg-amber-600 active:bg-amber-700">
                    Buka Sesi untuk Memanggil
                </button>
            </template>
            <template x-if="counterId">
