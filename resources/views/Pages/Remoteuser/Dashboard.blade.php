    ...
    <div class="flex-1 px-4 sm:px-5 pt-5 pb-8">
        ...
        <div class="mb-5 space-y-3">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-5 shadow-lg shadow-blue-200/50">
                ...
                <p class="text-blue-200 text-xs mb-3">{{ $activeQueue->service->service_name ?? 'Layanan Tidak Diketahui' }} &middot; est. ± 20 menit</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div x-data="{ expanded: false }"
                 class="bg-white rounded-2xl border {{ $c['border'] }} shadow-sm {{ $c['shadow'] }} overflow-hidden transition-all duration-300 {{ $hasActiveQueue ? 'opacity-50 pointer-events-none' : '' }}">
                ...
                <div x-show="expanded" x-cloak
                    ...
                    <div class="pt-3">
                        ...
                        <p class="text-xs text-gray-500 leading-relaxed">{{ $svc->description ?: 'Layanan pendaftaran antrean untuk '.$svc->service_name }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-1.5">
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 {{ $c['text'] }} shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                                <span class="text-xs text-gray-600 leading-relaxed">Warga Negara Indonesia (WNI)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 {{ $c['text'] }} shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                                <span class="text-xs text-gray-600 leading-relaxed">Terdaftar di wilayah instansi terkait</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-1.5">
                            <li class="flex items-start gap-2">
                                ...
                                <span class="text-xs text-gray-600 leading-relaxed">Kartu Keluarga & KTP Asli</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                {{-- Tombol Pilih --}}
                <div class="px-4 pb-4">
                    <a href="{{ route('booking.konfirmasi', ['layanan' => $slug]) }}"
                       class="flex items-center justify-center gap-1.5 w-full py-3 {{ $c['btnBg'] }} text-white text-xs font-bold rounded-xl shadow-sm transition {{ $hasActiveQueue ? 'pointer-events-none cursor-not-allowed opacity-50' : '' }}">
                        Pilih Layanan Ini
