                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-10">
                        <div>
                            ...
                            <input type="text" name="instance_name" value="{{ old('instance_name') }}" required class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-3 transition-colors" placeholder="e.g. RSUD Jakarta">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex rounded-md shadow-sm">
                                ...
                                <input type="text" name="instance_slug" value="{{ old('instance_slug') }}" required class="flex-1 block w-full rounded-none rounded-r-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-3 transition-colors" placeholder="rsud-jakarta">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="whatsapp_number" value="{{ old('whatsapp_number') }}" required class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-3 transition-colors" placeholder="6281234567890">
                            <p class="text-xs text-gray-500 mt-2 flex items-center">
                                <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        ...
                        <div>
                            ...
                            <input type="text" name="instance_code" value="{{ old('instance_code', Str::uuid()->toString()) }}" required class="block w-full rounded-lg border-gray-200 bg-gray-100 text-gray-500 focus:ring-0 sm:text-sm px-4 py-3 cursor-not-allowed" readonly>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="admin_name" value="{{ old('admin_name') }}" required class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-3 transition-colors" placeholder="Admin Full Name">
                        </div>
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="admin_email" value="{{ old('admin_email') }}" required class="block w-full pl-10 rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-3 transition-colors" placeholder="admin@example.com">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="admin_password" required minlength="8" class="block w-full pl-10 rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-3 transition-colors" placeholder="••••••••">
                                </div>
                            </div>
                        </div>
                    </div>
