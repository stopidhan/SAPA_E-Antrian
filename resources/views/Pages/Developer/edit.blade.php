        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('developer.instances.update', $instance->id) }}" method="POST">
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-10">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-md shadow-sm">
                                ...
                                <input type="text" name="instance_slug"
                                    value="{{ old('instance_slug', $instance->instance_slug) }}" required
                    ...
                    <div
                        class="bg-white rounded-lg border-2 border-gray-100 p-5 hover:border-blue-100 transition-colors">
                        <div class="flex items-start">
                            <div class="flex items-center h-6">
                                <input type="hidden" name="is_active" value="0">
                                <input type="checkbox" name="is_active" value="1"
                                    {{ old('is_active', $instance->is_active) ? 'checked' : '' }}
                ...
                <div class="px-8 py-5 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                    <div>
                        <span
                            class="text-sm text-gray-500 flex items-center bg-white px-3 py-1.5 rounded-lg border border-gray-200">
